...
public class FV_Food {
    String ten_mon;
    String gia_tien;
    String so_luot_mua;
    String so_luot_danh_gia_tot;
    String so_luot_danh_gia_khong_tot;
    String link_hinh;
    String danh_muc;

    public FV_Food(String ten_mon, String gia_tien, String so_luot_mua, String so_luot_danh_gia_tot, String so_luot_danh_gia_khong_tot, String link_hinh, String danh_muc) {

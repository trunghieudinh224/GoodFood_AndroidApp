...
public class VoucherAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        txt_hsd_voucher.setText("HSD: " + arrayVoucher.get(position).getHsd());

        ImageView img_ic_voucher = (ImageView) view.findViewById(R.id.img_ic_voucher);
        img_ic_voucher.setImageResource(R.drawable.vivoucher_tttk);

        ImageView img_vip_member = (ImageView) view.findViewById(R.id.img_vip_member);
        if (arrayVoucher.get(position).getLoai_voucher().equals("vip"))
        {
            img_vip_member.setImageResource(R.drawable.ic_vip_member);
            img_vip_member.setVisibility(View.VISIBLE);
        }
